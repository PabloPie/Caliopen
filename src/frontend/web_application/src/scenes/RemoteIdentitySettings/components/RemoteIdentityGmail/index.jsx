...
@withI18n()
@withAuthorizePopup()
class RemoteIdentityGmail extends Component {
  static propTypes = {
  ...
  validate = () => {
    ...
    if (
      ...
      this.setState({
        formErrors: {
          identifier: [(
            <Trans id="remote_identity.form.gmail.identifier.error">a valid gmail address is required</Trans>
          )],
        },
      });
    } else {
    ...
    return (
      <div>
        ...
        <Button
          ...
          icon={this.state.hasActivity ? (<Spinner isLoading display="inline" />) : 'google'}
  ...
  renderFormPhase1 = () => {
    ...
    return (
      <Fragment>
        <Callout color="info">
          <Trans id="remote_identity.gmail_how_to">
            You will be asked to signin to gmail and authorize Caliopen to access to your account.
            Afterward you will be able to see your last messages and send mails using your gmail
            account.
          </Trans>
        </Callout>
        <FormGrid>
...
export default RemoteIdentityGmail;
